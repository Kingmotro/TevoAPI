			...
			if (UtilPlayer.hasRank(p, Rank.ADMIN))
			{
				if (args.length > 0)
				{
					...
					if (target != null)
					{
						...
						UtilPlayer.message(Category.WORLD, p, CC.tnInfo + "Set time of " + CC.tnValue + target.getName() + CC.tnInfo + " to " + CC.tnValue + "18000" + CC.end);
					}
					else
					{
				...
				else
				{
					...
					UtilPlayer.message(Category.WORLD, p, CC.tnInfo + "Set time of " + CC.tnValue + p.getWorld().getName() + CC.tnInfo + " to " + CC.tnValue + "18000" + CC.end);
				}
			}
			else
			{
